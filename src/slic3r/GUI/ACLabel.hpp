...
class ACLabel : public wxStaticText
{
public:
    ACLabel(wxWindow *parent, wxString const &text = {}, long style = 0);

	ACLabel(wxWindow *parent, wxFont const &font, wxString const &text = {}, long style = 0);
