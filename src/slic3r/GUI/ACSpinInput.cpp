    ...
    , text_color(std::make_pair(0x909090, (int) ACStateColor::Disabled), std::make_pair(0x262E30, (int) ACStateColor::Normal))
{
    ...
    border_color     = ACStateColor(
        std::make_pair(AC_COLOR_SPINBOX_BD_DIS, (int) ACStateColor::Disabled), 
    ...
    background_color = ACStateColor(
        std::make_pair(AC_COLOR_SPINBOX_BG_DIS, (int) ACStateColor::Disabled), 
...
{
    auto btn = new ACButton(this, "", inc ? "spin_inc" : "spin_dec", wxBORDER_NONE, 6);
